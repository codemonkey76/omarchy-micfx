...
var STAGES = [
  { title: "INPUT", toggle: "", controls: [
    { key: "gain", label: "Gain", unit: "dB", min: -12, max: 24, step: 0.5 } ] },
  { title: "HIGH-PASS", toggle: "hpf.enabled", controls: [
    { key: "hpf.freq", label: "Frequency", unit: "Hz", min: 20, max: 300, step: 5 } ] },
  { title: "NOISE SUPPRESSION", toggle: "suppress.enabled", controls: [
    { key: "suppress.strength", label: "Strength", unit: "%", min: 0, max: 100, step: 1 },
    { key: "suppress.vad", label: "Voice detection", unit: "%", min: 0, max: 95, step: 1 } ] },
  { title: "NOISE GATE", toggle: "gate.enabled", controls: [
  ...
  { title: "COMPRESSOR", toggle: "comp.enabled", controls: [
    ...
    { key: "comp.attack", label: "Attack", unit: "ms", min: 0, max: 200, step: 1 },
    { key: "comp.release", label: "Release", unit: "ms", min: 10, max: 1000, step: 5 } ] },
  { title: "LIMITER", toggle: "limit.enabled", controls: [
